...
namespace IMusic.Migrations
{
    ...
    [Migration("20241019070225_song-model-1")]
    partial class songmodel1
    {
            ...
            modelBuilder.Entity("IMusic.Models.SongModel", b =>
                {
                    ...
                    b.Property<string>("GenrePK_sGenreId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("IMusic.Models.SongModel", b =>
                {
                    b.HasOne("IMusic.Models.GenreModel", "Genre")
                        .WithMany()
                        .HasForeignKey("GenrePK_sGenreId");
